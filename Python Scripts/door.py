# How to call the script from the shell:
...
GPIO.setup(13,GPIO.OUT)             #servoPin
...
try:
    ...
    for encoding in encodings:
        ...
        names.append(name)
    if(len(names) == 0):
        print("There is no one in front of the camera")
        subprocess.call(['/home/pi/Desktop/suspect.sh'])    #call a script to save the picture and upload it on firebase
        
    elif(names[0]=="Unknown"):
        print("Unknown person")
        subprocess.call(['/home/pi/Desktop/suspect.sh'])

    else:
        print("Welcome {}".format(names[0]))
        servo.ChangeDutyCycle(7.5)      #open the door
        time.sleep(5)
        servo.ChangeDutyCycle(2.5)      #close the door
        time.sleep(1)
